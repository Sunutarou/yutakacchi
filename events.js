 ...
 { text: "図鑑登録" },
...

    {
        ...
        steps: [
            ...
            { speaker: "ゆかりママ", text: "「あんた、若いんだから。<br>ジムいってるでしょ。<br>年寄りをいたわりなさい。」" },
            { text: "結局持たされた。疲れた。。" }
        ],
        effects: {
            money: 0,
...
　　　　　 { speaker: "ゆかりママ", text: "「ここからよ！」" },
            ...
            { speaker: "青リンゴ", text: "「おじさん、60超えてからもう<br>数えてないもんｗ」" },
  　　　　　{ speaker: "こころ", text: "「こわー。。。😱」" },
            { speaker: "青リンゴ", text: "「ママ、おじさんもシャンパン<br>入れちゃおうかな」" },
...
　{ speaker: "ゆたかママ", text: "「わーい。」" },
            { speaker: "ゆたかママ", text: "「ありがとう。うれしいー！」" },
 { image: "Yutaka.hbd.png", text: "みんなで盛り上がった。" },
            { text: "仕事だけど楽しかった。" },
            { text: "図鑑登録" },
            { text: "🎂 40歳ケーキゲット" },
...
},
{
    ...
    steps: [
        ...
        { speaker: "くさみ", text: "「ドンペリいいんですかー？」" },
        { speaker: "ゆかりママ", text: "「こらっ！🤣」" },
        { speaker: "くさみ", text: "「いつまでもあると思うな髪の毛とニコニコ😂」" },
        { speaker: "青リンゴ", text: "「もう（毛）ないじゃん、なんちゃって🤣」" },
        { speaker: "くさみ", text: "「なんか言った？皿洗い？」" },
...
　　{ image: "yes.png", text: "「いえーい！」" },
{ speaker: "くさみ", text: "「青リンゴさん、、、ｗｗ」" },
...
},
{
    ...
    steps: [
        ...
        { text: "今日のニコニコは<br>青リンゴさんに任せることにした。" },
        { text: "📱" },
        { speaker: "聖奈", text: "「えっ！？」" },
        { speaker: "なお", text: "「仕事は？🤣」" },
        { speaker: "ゆたかママ", text: "「知らなーい。<br>青リンゴがなんとかするわよ。」" },
        { speaker: "ゆたかママ", text: "「明日、日光集合ね！」" },
        { text: "こうして3人は翌日、<br>日光に集合することとなった。" },
        { speaker: "ゆたかママ", text: "「あー、今日はもう動きたくないから<br>ゴロゴロしよ～。」" },
        { speaker: "ゆたかママ", text: "「ん！？」" },
        { speaker: "ゆたかママ", text: "「あれ！？😅」" },
        { speaker: "ゆたかママ", text: "「玉の裏が臭い！？臭実きた？😨」" },
        { speaker: "ゆたかママ", text: "「疲れて、<br>昨日から風呂入ってないからだわ。」" },
        { speaker: "ゆたかママ", text: "「こうなったら、<br>ひっくり返して乾かすしかないわ！」" },
        { text: "バサバサ！" },
        ...
        { text: "なぜか<br>聖奈がイトコのスヌタロウになっていた。" },
        { text: "その後。" },
        { text: "🐰 金のうさぎ" },
        { image: "Yutaka.nikko2.dot.png" },
        { speaker: "ゆたかママ", text: "「かわいい♡」" },
        { speaker: "ゆたかママ", text: "「癒される♡」" },
        { speaker: "ゆたかママ", text: "「みんなでお揃いの金ウサギキーホルダー<br>買おう？」" },
...
steps: [
{ text: "🌃 新宿二丁目" },
 { image: "Mirai.jpg", text: "今日はなおがオーナーのみらいラウンジへ。" },
{ text: "🚪" },
{ text: "カランコロン" },
...
},
{
    ...
    rate: 0,
    steps: [
        { image: "Yutaka.kenta.dot.png", text: "今日はコタニとケンタッキーへ行った。<br>初デートでケンタは初めてだわ🤣<br>でもそのセンス、、、素敵かも。<br>ちょっと小食ぶってみたけど、<br>もっと食べたかった😝" },
...
successText: "「気が合うね😊」",
failSteps: [
    { speaker: "恋人", text: "「なんでやねん！ゆたかママと言えば<br>ケンタ！」" },
    { speaker: "恋人", text: "「しつこいくらいリツイートしてるじゃん！」" },
    { text: "今後彼からのナイモン連絡がくることは<br>なかった。。" },
    { text: "デート失敗💩" }
],
    effects: {
        money: -2000,
...
successText: "「気が合うね🤣」",
failSteps: [
    { speaker: "恋人", text: "「なんでやねん！」" },
    { text: "今後、彼からのナイモン連絡がくることは<br>なかった。。" },
    { text: "デート失敗💩" }
],
    effects: {
        money: -10000,
...
},
{
    ...
    failSteps: [
        { speaker: "恋人", text: "「ゆたか愛が足りないな～」" },
        { speaker: "恋人", text: "「山形に決まってるべ。」" },
        { speaker: "恋人", text: "「残念だけど、君とはうまくいかなそうだ。」" },
        { text: "破局した。。" }
    ],
    effects: {
        money: 0,
...
},
{
    ...
    failSteps: [
        { speaker: "恋人", text: "「ゆたかママレベルまだまだだな」" },
        { speaker: "恋人", text: "「梅酒自作してるじゃん！」" },
        { speaker: "恋人", text: "「今日、せっかくうんこミュージアム行ったのに。」" },
...
},
{
    ...
    steps: [
        ...
        { speaker: "なお", text: "「最近やばいね。ゆたかママ、<br>恋愛依存体質なのかな。」" },
        { text: "数時間後。" },
        ...
        { speaker: "青リンゴ", text: "「結婚するって言って辞めてから、<br>来ないもん。」" },
...
,
{
    ...
    　　{ speaker: "オオタニ", text: "「ちゃんと72kgも切ってくれたしね。」" },
...
,
{
    ...
    steps: [
        ...
        { speaker: "オオタニ", text: "「独立おめでとう！」" },
        { image: "Yutaka.propose.dot.png", text: "" },
        { speaker: "オオタニ", text: "「ちゃんと72kgも切ってくれた。」" },
        { speaker: "オオタニ", text: "「結婚してください。」" },
        { text: "【はい❤️】" },
        { image: "Yutaka.wedding.dot.png", text: "" },
        { text: "数年後" },
...
var under50kgEvent = window.under50kgEvent = {
    id: "SYS_UNDER_50KG",
    title: "げきやせ",
    steps: [
        { image: "Yutaka.gekiyase.png", text: "【50kg未満イベント】" },
        { speaker: "聖奈", text: "「……あれ？」" },
        { speaker: "聖奈", text: "「ゆたかママ、最近細くない？ほそみ？」" },
 { image: "Yutaka.gekiyase.png", text: "「ダイエットよ、ダイエット！」" },
        { speaker: "こころ", text: "「いや、痩せすぎでしょ……。」" },
        { speaker: "聖奈", text: "「えっ、何キロあるの？」" },
        { image: "Yutaka.gekiyase.png", text: "「49とか？」" },
        { speaker: "こころ", text: "「50kg切ってるじゃん！！」" },
  { image: "Yutaka.gekiyase.png", text: "「うふふふ。」" },
        { speaker: "聖奈", text: "「凄いけど……ちょっと心配になる細さだね。」" },
        { speaker: "こころ", text: "「痩せすぎてかわいくなくなってるよ！」" },
  { image: "Yutaka.gekiyase.png", text: "「え、、、😨」" },
        { speaker: "こころ", text: "「だって、モテてないでしょ？」" },
  { image: "Yutaka.gekiyase.png", text: "「・・・」" },
        { text: "翌日" },
        { speaker: "聖奈", text: "「心配だから、弁当買ってきたよ！」" },
        { speaker: "こころ", text: "「わたしはケンタ買ってきた！」" },
        { speaker: "なお", text: "「ゆたかママやばいんだって？<br>パスタ持ってきたよ！」" },
  { image: "Yutaka.gekiyase.png", text: "「アンタたち、やっぱり太らせたいね！」" },
        { text: "ゆたかママの激やせを心配した仲間から<br>大量の差し入れが届いたのであった。" },
  { text: "太るのは嫌だけど、<br>みんなの優しさを感じたわ。" },
        { text: "図鑑登録" },
        { text: "🦴 げきやせみゲット！" }
    ],
    effects: { money: 0, energy: 30, stress: -30, weight: 5 },
    encyclopedia: "🦴 げきやせみ"
};
