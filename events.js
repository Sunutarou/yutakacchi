 ...
 { text: "図鑑登録" },
    ...
    },
    {
        ...
        steps: [
            ...
            { speaker: "ゆたかママ", text: "「ちょっと。そっち？🤣みらいラウンジでタコスやってるのに。」" },
...
},
{
    ...
    steps: [
        ...
        { text: "チョッピもいってきた。スヌタロウがママって呼ばないか冷や冷やしたｗ" },
        { text: "でも楽しかった。" },
        { text: "図鑑登録" },
        { text: "⚓ TUGBOATEゲット" }
    ],
...
},
{
    ...
    steps: [
        ...
        { speaker: "ナレーション", text: "ゆたかママは夢だった自分の店を持った。<br>たくさんの仲間に囲まれ、<br>今日も笑いながら生きている。" },
...
,
{
    ...
    rate: 0,
    steps: [
        { text: "独立資金1000万円が貯まった。<br>私は新宿二丁目を選んだ。" },
        { text: "オープン初日。" },
        { image: "Yutaka.newbar.dot.png", text: "" },
